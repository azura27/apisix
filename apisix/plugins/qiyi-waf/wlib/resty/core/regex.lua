...
require "apisix.plugins.qiyi-waf.wlib.resty.core.time"  -- for ngx.now used by resty.lrucache
local lrucache = require "apisix.plugins.qiyi-waf.wlib.resty.lrucache"
