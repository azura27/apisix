...
local socket_logger = require "apisix.plugins.qiyi-waf.wlib.resty.logger.socket"
local ERR           = ngx.ERR
...
function _M.notice_log(msg)
	ngx.log(NOTICE, "qiyi-waf : " .. msg)
end

function _M.err_log(msg)
	ngx.log(ERR, "qiyi-waf error : " .. msg)
end
